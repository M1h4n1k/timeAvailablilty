...
function ActivityTextBox({hour, openEditActivityPopup, activity, isBetween}){
    return (
        <span className={
                "absolute -top-7 lg:-top-9 xl:-top-11 border-2 rounded-xl h-6 lg:h-7 lg:h-8 w-24 xl:w-36 xl:w-44 flex items-center justify-center z-10 dark:text-white " +
                "text-xs xl:text-sm xl:text-base" +
                (isBetween(hour) === 2 ? 'translate-x-4 xl:translate-x-6 xl:translate-7' : '')
            }
...
function HourBlock({freeTime, hour, activity, openEditActivityPopup, timePress, timeOver}) {
    ...
    return (
        <div
            className={
                "first:rounded-l-[100%] last:rounded-r-[100%] w-8 h-8 lg:w-12 lg:h-12 xl:w-14 xl:h-14 relative dark:text-white " +
...
function AddButton({addNewRange}) {
    return (
        <div onClick={addNewRange} className="text-5xl font-bold cursor-pointer active:scale-75 transition-all w-4 h-4 xl:w-6 xl:h-6 xl:w-7 xl:h-7">
...
function DeleteButton({deleteRange}) {
    return (
        <div onClick={deleteRange} className="text-5xl font-bold cursor-pointer active:scale-75 transition-all w-4 h-4 xl:w-6 xl:h-6 xl:w-7 xl:h-7">
